...
export class ContentListComponent implements OnInit {
  ...
  this.content = [{
    ...
    creator: 'Stan lee',
    imgURL: 'https://cdn.britannica.com/49/182849-050-4C7FE34F/scene-Iron-Man.jpg',
  ...
  },
  {
    ...
    creator: 'Zack Stentz',
    tags: ['Action', 'Adventure', 'Comedy'],
    imgURL: 'https://cdn.britannica.com/73/182873-050-E1C686F4/Chris-Hemsworth-Thor-Thor-The-Dark-World.jpg',
  },
  {
    id:3,
    title: 'Hulk',
    ...
    creator: 'Stan lee',
    imgURL: 'https://m.media-amazon.com/images/M/MV5BMjAxMDQ1MDE0Ml5BMl5BanBnXkFtZTcwOTc0MTIyMw@@._V1_.jpg',
    type: 'Super Hero',
  ...
  },
  {
    ...
    creator: 'Stan lee',
    imgURL: 'https://media.gq-magazine.co.uk/photos/63468efef4f48bee2acb7062/16:9/w_1280,c_limit/Tom-Holland-Spiderman-what-we-know-so-far.jpg',
    type: 'Super hero',
    tags: ['Action', 'Adventure', 'Comedy', 'Drama', 'Fantasy']
  },
]
